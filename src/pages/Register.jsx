  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 ">
      <Card>
        ...
        <div className="mt-6">
          <p className="text-center text-gray-500 text-sm mb-3 ">Or Register with</p>
          <div flex flex-col gap-3>
            <button w-full py-2 border border-gray-300 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-100 transition >
              <img
